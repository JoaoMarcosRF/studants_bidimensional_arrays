...
public class biDArraysChallenge{
    public static void main(String[] args){
        ...
        int studantGrades = input.nextInt();

        double[][] studantsGradesArray = new double[studantCount][studantGrades];

        double average = 0;

        //set
        for(int lines = 0; lines < studantCount; lines++){
            for(int rows = 0; rows < studantGrades; rows++){
        ...
        System.out.printf("A media geral da turma é igual a: %.02f", average / (studantCount * studantGrades));
